...
public class MyStackTest {
	...
	public MyStack<String> doubleS;
	// STUDENT: add variables as needed for your student tests
	public String p="p", q="q", s="s",o="o",
        r="r";
	public ArrayList<String>catchs=new ArrayList<String>();
	...
	public void testToStringStudent() throws StackOverflowException {
		...
		assertEquals("pq",doubleS.toString());
		doubleS.push(s);
		assertEquals("pqs",doubleS.toString());
		doubleS.push(o);
		assertEquals("pqs",doubleS.toString());
